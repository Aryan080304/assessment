        ...
        <div>
            ...
            <form method="post" action="AddStudent.php">
              ...
              if ($link === false) {
               ...
               $sql = mysqli_query($link, "SELECT ClassID, Classname FROM Class");
              ...
              if ($link === false) {
               ...
               $sql = mysqli_query($link, "SELECT ParentsID, Name FROM parents");
              while ($row = $sql->fetch_assoc()){
              echo "<option value='{$row['ParentsID']}'>{$row['Name']}</option>";
              }
              ?>  
               </select><br>
              ...
              if ($link === false) {
               ...
               $sql = mysqli_query($link, "SELECT SportsID, sportsname FROM sports");
              while ($row = $sql->fetch_assoc()){
              echo "<option value='{$row['SportsID']}'>{$row['sportsname']}</option>";
              }
              ?>   
              </select><br>
         ...
         <label for="medicalinformation">medicalinformation:</label>
    	   <input type="text" name="medicalinformation"><br>
